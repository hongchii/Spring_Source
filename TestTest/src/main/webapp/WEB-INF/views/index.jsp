	...
	<body>
		...
		<!-- Header -->
			<header id="header" class="alt">
				<div class="logo"><a href="index.html">I'm Find <span>by TEMPLATED</span></a></div>
				<a href="#menu">Menu</a>
			</header>
		...
		<!-- Banner -->
			<section class="banner full">
				<article>
					<img src="${pageContext.request.contextPath}/resources/images/slide01.jpg" alt="" />
					<div class="inner">
						<header>
							...
							<div class="box">
								...
								<div class="content">
									...
									<footer class="align-center">
										<a href="#" class="button alt">들어가기</a>
									</footer>
								</div>
							</div>
						</div>
			...
			<section id="three" class="wrapper style2">
				<div class="inner">
					...
					<div class="gallery">
						<div>
							<div class="image fit">
								<a href="#"><img src="${pageContext.request.contextPath}/resources/images/pic01.jpg" alt="" /></a>
							</div>
						</div>
						<div>
							<div class="image fit">
								<a href="#"><img src="${pageContext.request.contextPath}/resources/images/pic02.jpg" alt="" /></a>
							</div>
						</div>
						<div>
							<div class="image fit">
								<a href="#"><img src="${pageContext.request.contextPath}/resources/images/pic03.jpg" alt="" /></a>
							</div>
						</div>
						<div>
							<div class="image fit">
								<a href="#"><img src="${pageContext.request.contextPath}/resources/images/pic04.jpg" alt="" /></a>
							</div>
						</div>
					</div>
				</div>
