                                ...
                                <div class="tab-pane fade-in active" id="tab-1" role="tabpanel">
                                    <div class="product-content">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-5">
                                                <img src="${pageContext.request.contextPath}/resources/img/product-single/tab-desc.jpg" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="tab-pane fade" id="tab-3" role="tabpanel">
                                    <div class="customer-review-option">
                                        ...
                                        <div class="comment-option">
                                            ...
                                            <div class="co-item">
                                                <div class="avatar-pic">
                                                    <img src="${pageContext.request.contextPath}/resources/img/product-single/avatar-2.png" alt="">
                                                </div>
                                                <div class="avatar-text">
                                                    <div class="at-rating">
                                                        <i class="fa fa-star"></i>
